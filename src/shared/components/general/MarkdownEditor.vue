<template>
  <div class="markdown-e-container">
    <textarea class="markdown-e" ref="markdownRef"></textarea>
  </div>
</template>
  ...
  const easyMDE = new EasyMDE({
    ...
    status: [
      ...
      "cursor",
      {
        ...
        onUpdate: (el) => {
          emit("dataUpdated", easyMDE.value());
        },
      },
    ],
  });
...
.markdown-e-container {
  ...
  .CodeMirror-cursor {
    @apply w-0 border-l border-slate-900 dark:border-slate-100;
  }
